...
" hi Visual ctermfg=white ctermbg=black cterm=NONE guifg=NONE guibg=#2E2F31 gui=NONE
hi Visual      cterm=NONE    ctermfg=Black      ctermbg=LightGrey  gui=NONE    guifg=Black guibg=Grey70
